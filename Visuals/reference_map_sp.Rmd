...
map <- ggplot() + 
  ...
  labs(title ="Distrito de escuelas secundarias de Antelope Valley Union (AVUHSD)",
       ...
       caption = "Recursos: US Census, 2023; LA County Department of Public Health, 2022; California Department of Education, 2024-25.") +
