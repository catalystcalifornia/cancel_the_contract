# Create relational table for people stopped by race in AVUHSD schools
...
table_name <- "rel_school_race_recode"
schema <- "data"
indicator <- "Relational table of every stop/person in an AVUHSD school and their race with recoding for multiracial people 
as well as flags for AIAN/NHPI/SSWANA AOIC. Anyone with 6+ races indicated 
